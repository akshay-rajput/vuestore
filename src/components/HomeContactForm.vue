            ...
            <div class="contact-form px-4 py-6">
                ...
                <form @submit.prevent="onSubmitContactForm">
                    ...
                    <button type="submit" class="btn-contactform">
                        ...
                        <span class="">
                            <span class="fa fa-paper-plane text-xs"></span>
